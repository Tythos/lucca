/*	Library of Utilities for C/C++ Astrodynamics
	Library header
	Brian Kirkpatrick
	Created 4/15/2013
*/
...
namespace Lucca {
	...
	class Lambert {
		...
		public:
			Lambert();
			solve(float dt_s, bool isPrograde, Eigen::Vector3f &v1Eci_mps, Eigen::Vector3f &v2Eci_mps);
			float charTime();
			Orbel charOrb();
	};
	...
	namespace Earth {
		extern float alb;
		extern float e2;
		extern float radius_m;
		extern float mass_kg;
		extern float rotVel_radps;
		extern float flat;
		extern Orbel orbit;
		extern float mu;
		extern float e2;
